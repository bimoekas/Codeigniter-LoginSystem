...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Your account has been created successfully and is ready to use. Please Activate on your Account. Check your email!</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            'protocol' => 'smtp',
            'smtp_host' => 'ssl://admin@bnb-log.website',
            'smtp_user' => 'admin@bnb-log.website',
            'smtp_pass' => 'Cybershoot40!',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('testemailbaru12@gmail.com', 'Test Email');
    ...
    public function verify()
    {
        ...
        if ($user) {
            ...
            if ($user_token) {
                if (time() - $user_token['is_active'] = (1 * 1 * 1)) {
